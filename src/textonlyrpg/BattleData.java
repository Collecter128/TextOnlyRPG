...
public class BattleData {
	...
	public BattleData(int BattleNo, MonsterData[] MonsterD, int Event, int Drop1, int Drop1Percent, int Exp, int MoneyDrop, int MoneyChance, int EscapeChance, int EndEvent, int BattleScreenMode, String[] RandomText){
	...
	public static BattleData GetBattleData(int BattleNo){
		MonsterData[] MBattle = new MonsterData[1];
			...
			if(BattleNo == 1){
				MBattle = new MonsterData[1];{
					MBattle[0] = MonsterData.MData(22, 0);//Slime
				}
			...
			if(BattleNo == 2){
				MBattle = new MonsterData[1];{
					MBattle[0] = MonsterData.MData(40, 0);//Extoplasm
				}
			...
			if(BattleNo == 3){
				MBattle = new MonsterData[1];{
					MBattle[0] = MonsterData.MData(4, 0);//Giant Slime
				}
			...
			if(BattleNo == 4){
				MBattle = new MonsterData[2];{
					MBattle[0] = MonsterData.MData(40, 0);//Extoplasm
					MBattle[1] = MonsterData.MData(40, 0);//Extoplasm
				}
		...
		if(BattleNo == 5){
			MBattle = new MonsterData[1];{
				MBattle[0] = MonsterData.MData(325, 0);//TestSlime
			}
		...
		if(BattleNo == 8){
			MBattle = new MonsterData[1];{
				MBattle[0] = MonsterData.MData(328, 0);//TestGhost
			}
		...
		if(BattleNo == 9){
			MBattle = new MonsterData[1];{
				MBattle[0] = MonsterData.MData(331, 0);//TestGolem
			}
		...
		if(BattleNo == 10){
			MBattle = new MonsterData[1];{
				MBattle[0] = MonsterData.MData(334, 0);//TestArmor
			}
		...
		if(BattleNo == 11){
			MBattle = new MonsterData[1];{
				MBattle[0] = MonsterData.MData(337, 0);//TestBoss
			}
		...
		if(BattleNo == 12){
			MBattle = new MonsterData[1];{
				MBattle[0] = MonsterData.MData(340, 0);//TestMonsterHP 6
			}
		...
		if(BattleNo == 13){
			MBattle = new MonsterData[1];{
				MBattle[0] = MonsterData.MData(343, 0);//TestMonsterAtk 7
			}
		...
		if(BattleNo == 14){
			MBattle = new MonsterData[1];{
				MBattle[0] = MonsterData.MData(346, 0);//TestMonsterDef 8
			}
		...
		if(BattleNo == 15){
			MBattle = new MonsterData[1];{
				MBattle[0] = MonsterData.MData(349, 0);//TestBoss2 9
			}
		...
		if(BattleNo == 16){
			MBattle = new MonsterData[1];{
				MBattle[0] = MonsterData.MData(352, 0);//TestSecretBoss 10
			}
		...
		if(BattleNo == 19){
			MBattle = new MonsterData[2];{
				MBattle[0] = MonsterData.MData(343, 0);//TestMonsterHP
				MBattle[1] = MonsterData.MData(346, 0);//TestMonsterHP
			}
		...
		if(BattleNo == 21){//??? Doppelganger???
			MBattle = new MonsterData[1];{
				MBattle[0] = MonsterData.MData(15, 0);
			}

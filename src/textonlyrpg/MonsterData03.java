			...
			if(MonsterNo == 217){
				MInfo = new MonsterData[]{
						...
						new MonsterData(217, "72", "217", new String[]{"Ice Dragon"}, new String[]{"IceDragon"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/6, 12, 
						...
						new MonsterData(217, "00?", "002", new String[]{"Ice Dragon"}, new String[]{"IceDragon"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(217, "BB", "BB3", new String[]{"Ice Dragon"}, new String[]{"IceDragon"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/6, 12, 
			...
			//012 Cold Jam
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(220, "01?", "012", new String[]{"Cold Jam"}, new String[]{"Cold Jam"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(220, "BSl", "BSl3", new String[]{"Cold Jam"}, new String[]{"Cold Jam"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/1, 12, 
			...
			//022 Frozen Curse
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(223, "02?", "022", new String[]{"Frozen Curse"}, new String[]{"FroznCurse"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(223, "BGh", "BGh3", new String[]{"Frozen Curse"}, new String[]{"FroznCurse"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/2, 12, 
			...
			//032 Gaint Statue
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(226, "03?", "032", new String[]{"Giant Statue"}, new String[]{"Gnt Statue"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(226, "BGo", "BGo3", new String[]{"Giant Statue"}, new String[]{"Gnt Statue"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/3, 0, 
			...
			//042 Coded Knight
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(229, "04?", "042", new String[]{"Coded Knight"}, new String[]{"CodedKnght"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(229, "BA", "BA3", new String[]{"Coded Knight"}, new String[]{"CodedKnght"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/4, 15, 
			...
			//0*2 Frost Edge
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(232, "0*?", "0*2", new String[]{"Frost Edge"}, new String[]{"Frost Edge"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(232, "B?", "B?3", new String[]{"Frost Edge"}, new String[]{"Frost Edge"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/5, 12, 
			...
			//102 Liquid Shadow
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(235, "10?", "102", new String[]{"Liquid Shadow"}, new String[]{"Lqd Shadow"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(235, "SlB", "SlB3", new String[]{"Liquid Shadow"}, new String[]{"Lqd Shadow"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/1, 14, 
			...
			//112 Extra Rare Slime
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(238, "11?", "112", new String[]{"Extra Rare Slime"}, new String[]{"ExRareSlme"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(238, "SlSl", "SlSl3", new String[]{"Extra Rare Slime"}, new String[]{"ExRareSlme"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/1, 0, 
			...
			//122 Transparent Slime
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(241, "12?", "122", new String[]{"Transparent Slime"}, new String[]{"TrnspntSlm"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(241, "SlGh", "SlGh3", new String[]{"Transparent Slime"}, new String[]{"TrnspntSlm"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/1, 0, 
			...
			//132 Icicle Slime
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(244, "13?", "132", new String[]{"Icicle Slime"}, new String[]{"IciclSlime"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(244, "SlGo", "SlGo3", new String[]{"Icicle Slime"}, new String[]{"IciclSlime"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/1, 12, 
			...
			//142 Armor Jell
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(247, "14?", "142", new String[]{"Armor Jell"}, new String[]{"Armor Jell"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(247, "SlA", "SlA3", new String[]{"Armor Jell"}, new String[]{"Armor Jell"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/1, 0, 
...
//			}
			...
			//1*2 Jelly!
				...
				MInfo = new MonsterData[]{
						...
						//4 = Other Story
						new MonsterData(250, "Sl?", "Sl?3", new String[]{"Jelly!"}, new String[]{"Jelly!"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/1, 15, 
			...
			//202 Frozen Wraith
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(253, "20?", "202", new String[]{"Frozen Wraith"}, new String[]{"FrznWraith"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(253, "GhB", "GhB3", new String[]{"Frozen Wraith"}, new String[]{"FrznWraith"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/2, 12, 
			...
			//212 Ectoplasm - Lv.9
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(256, "21?", "212", new String[]{"Ectoplasm Lv.9"}, new String[]{"EctplsmLv9"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(256, "GhSl", "GhSl3", new String[]{"Ectoplasm Lv.9"}, new String[]{"EctplsmLv9"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/2, 0, 
			...
			//222 Lingering Grudge
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(259, "22?", "222", new String[]{"Lingering Grudge"}, new String[]{"LngrgGrudg"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(259, "GhGh", "GhGh3", new String[]{"Lingering Grudge"}, new String[]{"LngrgGrudg"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/2, 0, 
			...
			//232 Ice Shadow
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(262, "23?", "232", new String[]{"Ice Shadow"}, new String[]{"IceShadow"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(262, "GhGo", "GhGo3", new String[]{"Ice Shadow"}, new String[]{"IceShadow"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/2, 12, 
...
//			}
			...
			//242 Cursed Armor
				...
				MInfo = new MonsterData[]{
						...
						//4 = Other Story
						new MonsterData(265, "GhA", "GhA3", new String[]{"Cursed Armor"}, new String[]{"Crsd Armor"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/4, 0, 
			...
			//2*2 Radio Static
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(268, "2*?", "2*2", new String[]{"Radio Static"}, new String[]{"RadioStatc"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(268, "Gh?", "Gh?3", new String[]{"Radio Static"}, new String[]{"RadioStatc"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/2, 15, 
...
//			}
			...
			//302 Ice Golem
				...
				MInfo = new MonsterData[]{
						//0 = Cutscene Quest
						new MonsterData(271, "90", "271", new String[]{"Big Ice Golem"}, new String[]{"BigIceGolm"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/3, 12, 
								/*MDEF*/0, 0, 0, 6, 1, "An Ice Golem", new String[]{"A golem of ice", "It's sort of clear"}, /*MSpeed*/100, /*ItemDrop?*/1, 50, /*Exp*/0, /*Money*/3, 30, /*Weakness*/new double[]{/*Unarmed*/0.0, /*Sword*/0.0, /*Lance*/0.0, /*Hammer*/0.0, /*Axe*/0.0, /*Pole*/0.0, /*Bomb*/0.0, /*Fire*/1.0, /*Water*/1.0, /*Wind*/1.0, /*Earth*/1.0, /*Electric*/1.0, /*Ice*/1.0, /*Light*/1.0, /*Dark*/1.0, /*Glitch*/1.0, /*Null*/1.0, /*Mystery*/1.0, /*Corrupt*/1.0, /*Admin*/1.0, /*All*/1.0}, /*WeaknessType*/new int[]{/*Unarmed*/0, /*Sword*/0, /*Lance*/0, /*Hammer*/0, /*Axe*/0, /*Pole*/0, /*Bomb*/0, /*Fire*/0, /*Water*/0, /*Wind*/0, /*Earth*/0, /*Electric*/0, /*Ice*/0, /*Light*/0, /*Dark*/0, /*Glitch*/0, /*Null*/0, /*Mystery*/0, /*Corrupt*/0, /*Admin*/0, /*All*/0}, /*Weak/Resist Text*/new String[] {"", "", "", ""}, new int[][]{{0,0,0},{0,0,0}}, 
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//1 = Normal Mode
						new MonsterData(271, "30?", "302", new String[]{"Big Ice Golem"}, new String[]{"BigIceGolm"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/3, 12, 
						...
						new MonsterData(271, "30?", "302", new String[]{"Big Ice Golem"}, new String[]{"BigIceGolm"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(271, "GoB", "GoB3", new String[]{"Big Ice Golem"}, new String[]{"BigIceGolm"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/3, 12, 
			...
			//312 Magma Golem
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(274, "31?", "312", new String[]{"Magma Golem"}, new String[]{"MagmaGolem"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(274, "GoSl", "GoSl3", new String[]{"Magma Golem"}, new String[]{"MagmaGolem"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/3, 7, 
			...
			//322 Chaotic Possesed Earth
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(277, "32?", "322", new String[]{"Chaotic Possesed Earth"}, new String[]{"CtcPssdEth"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(277, "GoGh", "GoGh3", new String[]{"Chaotic Possesed Earth"}, new String[]{"CtcPssdEth"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/3, 10, 
			...
			//332 Shiny Golem
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(280, "33?", "332", new String[]{"Shiny Golem"}, new String[]{"ShinyGolem"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(280, "GoGo", "GoGo3", new String[]{"Shiny Golem"}, new String[]{"ShinyGolem"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/3, 0, 
			...
			//342 Ore Golem
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(283, "34?", "342", new String[]{"Ore Golem"}, new String[]{"Ore Golem"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(283, "GoA", "GoA3", new String[]{"Ore Golem"}, new String[]{"Ore Golem"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/3, 0, 
			...
			//3*2 Broken Golem
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(286, "3*?", "3*2", new String[]{"Broken Golem"}, new String[]{"BrknGolem"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(286, "Go?", "Go?3", new String[]{"Broken Golem"}, new String[]{"BrknGolem"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/3, 18, 
			...
			//402 Coded Armor
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(289, "40?", "402", new String[]{"Coded Armor"}, new String[]{"CodedArmor"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(289, "AB", "AB3", new String[]{"Coded Armor"}, new String[]{"CodedArmor"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/4, 0, 
			...
			//412 River Armor
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(292, "41?", "412", new String[]{"River Armor"}, new String[]{"RiverArmor"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(292, "ASl", "ASl3", new String[]{"River Armor"}, new String[]{"RiverArmor"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/4, 8, 
			...
			//422 Mist Armor
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(295, "42?", "422", new String[]{"Mist Armor"}, new String[]{"Mist Armor"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(295, "AGh", "AGh3", new String[]{"Mist Armor"}, new String[]{"Mist Armor"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/4, 9, 
			...
			//432 Mountian Armor
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(298, "43?", "432", new String[]{"Mountian Armor"}, new String[]{"Mtn Armor"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(298, "AGo", "AGo3", new String[]{"Mountian Armor"}, new String[]{"Mtn Armor"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/4, 10, 
			...
			//442 Money Armor
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(301, "44?", "442", new String[]{"Money Armor"}, new String[]{"MoneyArmor"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(301, "AA", "AA3", new String[]{"Money Armor"}, new String[]{"MoneyArmor"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/4, 0, 
			...
			//4*2 Prototype Mech
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(304, "4*?", "4*2", new String[]{"Prototype Mech"}, new String[]{"ProtoMech"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(304, "A?", "A?3", new String[]{"Prototype Mech"}, new String[]{"ProtoMech"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/5, 0, 
						...
						new MonsterData(304, "???", "4*2", new String[]{"Type E Type"}, new String[]{"TypeEType"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/6, 11, 
			...
			//*02 Broken Sword
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(307, "*0?", "*02", new String[]{"Broken Sword"}, new String[]{"Brkn Sword"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(307, "?B", "?B3", new String[]{"Broken Sword"}, new String[]{"Brkn Sword"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/5, 18, 
			...
			//*12 Mad Subtractor
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(310, "*1?", "*12", new String[]{"Mad Subtractor"}, new String[]{"MadSbtrctr"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(310, "?Sl", "?Sl3", new String[]{"Mad Subtractor"}, new String[]{"MadSbtrctr"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/5, 0, 
			...
			//*22 Negative Image
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(313, "*2?", "*22", new String[]{"Negative Image"}, new String[]{"NgativImag"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(313, "?Gh", "?Gh3", new String[]{"Negative Image"}, new String[]{"NgativImag"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/5, 15, 
			...
			//*32 Terra Cotta Warrier
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(316, "*3?", "*32", new String[]{"Terra Cotta Warrier"}, new String[]{"TerraCotta"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(316, "?Go", "?Go3", new String[]{"Terra Cotta Warrier"}, new String[]{"TerraCotta"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/3, 0, 
			...
			//*42 D. A[]m[]r
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(319, "*4?", "*42", new String[]{"D. A[]m[]r"}, new String[]{"D. A[]m[]r"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/0, /*StatusC*/0),
						//4 = Other Story
						new MonsterData(319, "?A", "?A3", new String[]{"D. A[]m[]r"}, new String[]{"D. A[]m[]r"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/4, 14, 
			...
			//**2 Unknown Enemy
				...
				MInfo = new MonsterData[]{
						...
						new MonsterData(322, "**?", "**2", new String[]{"Unknown Enemy"}, new String[]{"UnknwnEnmy"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/4, /*StatusC*/80),
						//4 = Other Story
						new MonsterData(322, "??", "??3", new String[]{"Unknown Enemy"}, new String[]{"UnknwnEnmy"}, 
								/*MHP*/0, 0, 0, 5, 9, 1, 
								/*MATK*/0, 0, 0, 8, 1, /*MAtkElements*/6, 17, 
						...
						new MonsterData(322, "???", "**2", new String[]{"Lesser Unknown"}, new String[]{"LssrUnknwn"}, 
								...
								/*CriticalC*/0, /*DodgeC*/0, /*Status*/4, /*StatusC*/60)
				};
			}
//				//Mystery Enemy
//			else if(MonsterNo == 99){

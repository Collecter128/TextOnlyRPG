...
//			}
			...
			//032 Gaint Statue
				...
				MInfo = new MonsterData[]{
						...
						//6 = Beta
						new MonsterData(226, "000", "032", new String[]{"Frost Statue"}, new String[]{"FrstStatue"}, 
...
//			}
			...
			//042 Coded Knight
				...
				MInfo = new MonsterData[]{
						...
						//6 = Beta
						new MonsterData(229, "000", "042", new String[]{"Coded Armor"}, new String[]{"CodedArmor"}, 
...
//			}
			...
			//102 Liquid Shadow
				...
				MInfo = new MonsterData[]{
						...
						//6 = Beta
						new MonsterData(235, "000", "102", new String[]{"Stealth Slime"}, new String[]{"StlthSlime"}, 
...
//			}
			...
			//212 Ectoplasm - Lv.9
				...
				MInfo = new MonsterData[]{
						...
						//6 = Beta
						new MonsterData(256, "000", "212", new String[]{"Extoplasm Lv.9"}, new String[]{"ExtplsmLv9"}, 
...
//			}
			...
			//3*2 Broken Golem
				...
				MInfo = new MonsterData[]{
						...
						//6 = Beta
						new MonsterData(286, "000", "3*2", new String[]{"GLM"}, new String[]{"GLM"}, 
...
//			}
			...
			//402 Coded Armor
				...
				MInfo = new MonsterData[]{
						...
						//6 = Beta
						new MonsterData(289, "000", "402", new String[]{"Coded Knight"}, new String[]{"CodedKnght"}, 
...
//			}
			...
			//412 River Armor
				...
				MInfo = new MonsterData[]{
						...
						//6 = Beta
						new MonsterData(292, "000", "412", new String[]{"Icy Armor"}, new String[]{"Icy Armor"}, 
...
//			}
			...
			//4*2 Prototype Mech
				...
				MInfo = new MonsterData[]{
						...
						//6 = Beta
						new MonsterData(304, "000", "4*2", new String[]{"Type E Type"}, new String[]{"TypeEType"}, 
...
//			}
			...
			//*22 Negative Image
				...
				MInfo = new MonsterData[]{
						...
						//6 = Beta
						new MonsterData(313, "000", "*22", new String[]{"Megative Image"}, new String[]{"NgativImag"}, 
...
//			}
			...
			//*32 Terra Cotta Warrier
				...
				MInfo = new MonsterData[]{
						...
						//6 = Beta
						new MonsterData(316, "000", "*32", new String[]{"Super Fighting Terra Cotta"}, new String[]{"SpFtgTCtta"}, 
...
//			}
			...
			//**2 Unknown Enemy
				...
				MInfo = new MonsterData[]{
						...
						//6 = Beta
						new MonsterData(322, "000", "**2", new String[]{"Lesser Unknown"}, new String[]{"LssrUnknwn"}, 

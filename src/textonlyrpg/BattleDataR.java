...
public class BattleDataR {
	...
	public BattleDataR(int BattleNo, MonsterData[] MonsterD, int Event, int Drop1, int Drop1Percent, int Exp, int MoneyDrop, int MoneyChance, int EscapeChance, int EndEvent, int BattleScreenMode, String[] RandomText){
	...
	public static BattleData GetBattleData(int BattleNo){
		MonsterData[] MBattle = new MonsterData[1];
			...
			if(BattleNo == 1){
				MBattle = new MonsterData[1];{
					MBattle[0] = MonsterData.MData(24, 0);//Gold Slime
				}
			...
			if(BattleNo == 2){
				MBattle = new MonsterData[1];{
					MBattle[0] = MonsterData.MData(42, 0);//Pnk Extoplasm
				}
			...
			if(BattleNo == 3){
				MBattle = new MonsterData[1];{
					MBattle[0] = MonsterData.MData(6, 0);//Emerald Slime
				}
			...
			if(BattleNo == 4){
				MBattle = new MonsterData[2];{
					MBattle[0] = MonsterData.MData(42, 0);//Pnk Extoplasm
					MBattle[1] = MonsterData.MData(42, 0);//Pnk Extoplasm
				}
		...
		if(BattleNo == 5){
			MBattle = new MonsterData[1];{
				MBattle[0] = MonsterData.MData(327, 0);//RareSlime
			}
		...
		if(BattleNo == 6){
			MBattle = new MonsterData[2];{
				...
				MBattle[0] = MonsterData.MData(330, 0);//RareGhost
				...
				MBattle[0] = MonsterData.MData(333, 0);//RareGolem
			}
		...
		if(BattleNo == 10){
			MBattle = new MonsterData[1];{
				MBattle[0] = MonsterData.MData(336, 0);//RareArmor
			}
		...
		if(BattleNo == 11){
			MBattle = new MonsterData[1];{
				MBattle[0] = MonsterData.MData(339, 0);//RareBoss
			}
		...
		if(BattleNo == 12){
			MBattle = new MonsterData[1];{
				MBattle[0] = MonsterData.MData(342, 0);//SecretMonsterHP 6
			}
		...
		if(BattleNo == 13){
			MBattle = new MonsterData[1];{
				MBattle[0] = MonsterData.MData(345, 0);//SecretMonsterAtk 7
			}
		...
		if(BattleNo == 14){
			MBattle = new MonsterData[1];{
				MBattle[0] = MonsterData.MData(348, 0);//SecretMonsterDef 8
			}
		...
		if(BattleNo == 15){
			MBattle = new MonsterData[1];{
				MBattle[0] = MonsterData.MData(351, 0);//SecretBoss2 9
			}
		...
		if(BattleNo == 16){
			MBattle = new MonsterData[1];{
				MBattle[0] = MonsterData.MData(354, 0);//Secret 10
			}
		...
		if(BattleNo == 17){
			MBattle = new MonsterData[4];{
				...
				MBattle[1] = MonsterData.MData(330, 0);//RareGhost
				...
				MBattle[2] = MonsterData.MData(333, 0);//RareGolem
				...
				MBattle[3] = MonsterData.MData(336, 0);//RareArmor
			}
		...
		if(BattleNo == 18){//Dummy
			MBattle = new MonsterData[1];{
				...
				MBattle[0] = MonsterData.MData(357, 0);//Target
			}
		...
		if(BattleNo == 19){
			MBattle = new MonsterData[2];{
				MBattle[0] = MonsterData.MData(345, 0);//TestMonsterHP
				MBattle[1] = MonsterData.MData(348, 0);//TestMonsterHP
			}
		...
		if(BattleNo == 21){//??? Doppelganger???
			MBattle = new MonsterData[1];{
				MBattle[0] = MonsterData.MData(17, 0);
			}
		...
		if(BattleNo == 29){
			MBattle = new MonsterData[3];{
				MBattle[0] = MonsterData.MData(42, 0);//Pnk Extoplasm
				MBattle[1] = MonsterData.MData(42, 0);//Pnk Extoplasm
				MBattle[2] = MonsterData.MData(42, 0);//Pnk Extoplasm
			}
